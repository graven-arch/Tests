...
namespace SmsGo.Models
{
    public class BdContext : DbContext
    {
        ...
        public virtual DbSet<Profil_Communication> Profil_Communication { get; set; }
        public virtual DbSet<Profil_Exploitation> Profil_Exploitation { get; set; }
        public virtual DbSet<Profil_Parametrage> Profil_Parametrage { get; set; }
        ...
        protected override void OnModelCreating(DbModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Configurations.Add(new Pr_ComConfig());
            modelBuilder.Configurations.Add(new Pr_ExpConfig());
            modelBuilder.Configurations.Add(new Pr_ParamConfig());
